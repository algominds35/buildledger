        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-slate-900 rounded-3xl border-2 border-amber-400 p-8 flex flex-col relative">
              ...
              <p className="text-slate-400 text-sm mb-6">For bookkeepers, ProAdvisors, and Financial Controllers managing construction companies.</p>
              <ul className="space-y-2 mb-8 flex-1 text-sm text-slate-300">
                {['Works with QuickBooks Online', 'Auto-generate WIP schedules', 'Job costing & over/under billing', 'Multi-client dashboard', 'Retainage tracking', 'Export reports in seconds', 'Priority support'].map(f => (
              ...
              <Link href="/pricing" className="block w-full text-center py-3 bg-amber-400 hover:bg-amber-500 text-slate-900 font-bold rounded-xl transition-colors text-sm">Start free 14-day trial →</Link>
            </div>
            {/* Team */}
            <div className="bg-white rounded-3xl border border-slate-200 p-8 flex flex-col">
              ...
              <div className="flex items-end gap-1 mb-1"><span className="text-4xl font-extrabold text-slate-900">$199</span><span className="text-slate-400 mb-1">/mo</span></div>
              <p className="text-slate-500 text-sm mb-6">For firms managing multiple companies, clients, or higher usage.</p>
              <ul className="space-y-2 mb-8 flex-1 text-sm text-slate-600">
                {['Everything in Pro', 'Multiple companies / entities', 'Team access (multi-user)', 'Bulk report generation', 'Priority support'].map(f => (
              ...
              <Link href="/pricing" className="block w-full text-center py-3 bg-slate-900 hover:bg-slate-700 text-white font-bold rounded-xl transition-colors text-sm">Choose Team →</Link>
            </div>
            {/* Enterprise */}
            <div className="bg-white rounded-3xl border border-slate-200 p-8 flex flex-col">
              ...
              <p className="text-slate-500 text-sm mb-6">For large firms needing custom setup and dedicated support.</p>
              <ul className="space-y-2 mb-8 flex-1 text-sm text-slate-600">
                {['Everything in Team', 'Custom onboarding & training', 'White-label option', 'Dedicated account manager', 'Invoice billing available'].map(f => (
                  <li key={f} className="flex items-center gap-2"><svg className="w-4 h-4 text-emerald-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>{f}</li>
                ))}
              </ul>
              <a href="mailto:alex@reconcilebookapp.com?subject=Enterprise inquiry" className="block w-full text-center py-3 bg-slate-100 hover:bg-slate-200 text-slate-900 font-bold rounded-xl transition-colors text-sm">Contact us →</a>
            </div>
          </div>
