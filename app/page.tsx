  ...
  return (
    <div className="rounded-xl overflow-hidden shadow-2xl shadow-black/40 border border-white/10">
      <div className="bg-slate-700 px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1 bg-slate-600 rounded-md px-3 py-1 text-slate-400 text-xs font-mono">{url}</div>
      </div>
      {children}
    </div>
  )
...
function WipMockup() {
  const rows = [
    ...
    { name: 'Sunset Townhomes Ph.2', pct: 31, contract: '$650,000', billed: '$201,500', costs: '$175,000', over: '—', under: '$22,500', margin: '21.2%' },
  ]
  return (
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-6 gap-2 mb-3">
          {[
            ...
            { label: 'Over Billings', value: '$70,600', color: 'bg-red-50 border border-red-200 text-red-800' },
            ...
            <tbody className="divide-y divide-slate-100">
              {rows.map(r => (
                <tr key={r.name} className="hover:bg-slate-50">
                  ...
                  <td className="px-3 py-2 text-right">{r.under !== '—' ? <span className="text-amber-600 font-semibold">{r.under}</span> : <span className="text-slate-300">—</span>}</td>
...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="max-w-3xl mx-auto text-center pb-16">
            <div className="inline-flex items-center gap-2 bg-amber-400/10 border border-amber-400/30 text-amber-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-6">
              ...
              Built exclusively for construction bookkeepers
            </div>
            <h1 className="text-5xl md:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
              Replace your WIP spreadsheet{' '}
              <span className="text-amber-400">in 5 minutes.</span>
            </h1>
            <p className="text-lg text-slate-400 mb-10 leading-relaxed">
              ReconcileBook pulls live data from your clients' QuickBooks Online and instantly generates job costing reports, WIP schedules, and over/under billing summaries — no spreadsheets, no manual entry.
            </p>
          ...
          <div className="px-4 md:px-0">
            <BrowserMockup url="reconcilebook.com/dashboard">
              <DashboardMockup />
            </BrowserMockup>
          </div>
        </div>
      ...
      {/* ── TRUST BAR ───────────────────────────────────────────── */}
      <div className="border-y border-slate-100 py-8 bg-white">
        <div className="max-w-5xl mx-auto px-6">
          <p className="text-center text-slate-400 text-xs font-semibold uppercase tracking-widest mb-6">Trusted by bookkeepers who use</p>
      ...
      <section id="features" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 mt-4 text-lg max-w-2xl mx-auto">Stop building reports in spreadsheets. ReconcileBook pulls live data from QuickBooks and generates professional reports in seconds.</p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Total costs broken down by materials, labor, and subcontractors for every project — live from QuickBooks.',
                bullets: ['Materials, labor, subs breakdown', 'Budget vs. actual variance', 'Over-budget alerts', 'One-click PDF download'],
              },
              {
                title: 'WIP Schedules',
                desc: 'The report your contractor clients need for bonding and bank financing — auto-calculated using the cost-to-cost method.',
                bullets: ['% complete (cost-to-cost method)', 'Over/under billings', 'Retainage tracking', 'Revenue earned vs. billed'],
              },
              {
                title: 'Multi-Client Dashboard',
                desc: 'Manage every contractor client from one screen. Portfolio financials at a glance — no switching between files.',
                bullets: ['Full portfolio overview', 'Per-client financial summary', 'Open invoices & unpaid bills', 'Unlimited connected clients'],
              },
            ].map(f => (
              <div key={f.title} className="bg-slate-50 rounded-2xl p-7 border border-slate-100 hover:border-amber-200 transition-colors">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            <div className="bg-slate-900 rounded-2xl p-7 text-white">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">Download any report as a professionally formatted PDF — branded with company name and date. Send directly to clients, lenders, or bonding agents.</p>
            </div>
            <div className="bg-amber-400 rounded-2xl p-7">
              ...
              <p className="text-slate-800/70 text-sm leading-relaxed">Connect any contractor's QBO account in under a minute via secure OAuth. No manual data entry — reports always reflect live QuickBooks data.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { step: '03', title: 'Pull live data', desc: 'ReconcileBook instantly fetches all jobs, invoices, bills, and expenses from QuickBooks.' },
              { step: '04', title: 'Generate reports', desc: 'Open job costing or WIP reports. Download as PDF and send to your client in seconds.' },
            ].map(s => (
      ...
      <section id="testimonials" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <p className="text-amber-500 text-sm font-bold uppercase tracking-widest mb-3">What bookkeepers say</p>
            <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight">Finally, a tool that speaks our language</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                quote: "I used to spend 3 hours every month building WIP schedules in Excel. ReconcileBook does it in seconds — I just connect QuickBooks and the report is there.",
                name: 'Sarah M.',
                title: 'CPA · 12 construction clients',
              },
              {
                quote: "My clients needed WIP reports for bonding and I was manually calculating over/under billings. This completely replaced that process. Worth every penny.",
                name: 'James T.',
                title: 'Bookkeeper · Specializes in GCs',
              },
              {
                quote: "The job costing breakdown by materials, labor, and subs is exactly what my contractors ask for every month. I can't believe I was doing this manually before.",
                name: 'Maria R.',
      ...
      <section className="py-20 bg-amber-400">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-extrabold text-slate-900 mb-4 tracking-tight">
            Stop building WIP schedules in Excel.
          </h2>
